import { inserirAtor, getNacionalidades } from "../../atores.js";
...
const cadastrar = document.getElementById("cadastrar_ator");
...
cadastrar.addEventListener("click", async () => {
  ...
  ator = {
    ...
    foto: urlImg,
    id_sexo: sexo,
    nome_artistico : nome_artistico.value == null ? null : nome_artistico.value,
    nacionalidade: arrayNacionalidades
  }

 let isPosted = await inserirAtor(ator)
