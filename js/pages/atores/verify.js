import { getAtorById, getNacionalidades } from "../../atores.js";
...
console.log(ator);
    ...
    nome_artistico.value = ator.nome_artistico === null ? null: ator.nome_artistico
  
    if(ator.sexo[0].sigla == 'F'){
...
async function exibirNacionalidade(){
    try {
        ...
        nacionalidades.forEach((element) => {
          ...
          if (ator.nacionalidade.some((nacionality) => nacionality.nome === element.nome)) {
